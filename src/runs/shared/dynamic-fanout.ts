...
const RUNNER_DYNAMIC_PARALLEL_KEYS = new Set([
	...
	"systemPromptMode", "thinking", "modelCandidates", "requestedModel", "skippedModels", "sessionFile", "effectiveAcceptance", "acceptanceInput", "acceptanceRole", "parentSessionId", "requiredExtensions", "launchResolvedExtensions", "requestedCwd", "machineEnv",
]);
